(module
  ...
  (func $print_demo (type 7)
    ...
    global.set $__stack_pointer
    return)
  (func $square (type 2) (param i32) (result i32)
    ...
    local.get 6
    return)
  (func $is_even (type 2) (param i32) (result i32)
